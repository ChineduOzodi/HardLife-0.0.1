...
public class NameGen {
    ...
    public static int wordMaxLen = 10;
    public static string maleFirstNames;
    public static string worldNames;
    public static string regionNames;
    

    private static Dictionary<string, List<char>> worldNameTable;
    private static Dictionary<string, List<char>> regionNameTable;
    private static Dictionary<string, List<char>> maleFirstNameTable;
    ...
    private static string GenerateName(Dictionary<string, List<char>> table, string seed = null, string start = null)
    {
        int max = wordMaxLen;
        string s = start;
        if (start == null)
    ...
    private static string randomStartChoice(Dictionary<string, List<char>>.KeyCollection keys, string seed = null)
    {
    ...
    private static char randomChoice(List<char> charList)
    {
