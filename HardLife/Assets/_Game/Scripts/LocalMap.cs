...
public class LocalMap { //TODO Add comments to class
    ...
    {
        objectMap = new BaseObjectModel[localSizeX, localSizeY];
            ...
            for (int y = 0; y < localSizeY; y++)
            {
                ...
                if (biome != "Water") //water local map
                {
                    if (baseMap[x, y].type == "Grass")
                    {
                        ...
                        {
                            objectMap[x, y] = new BaseObjectModel("boulder", worldPoint,x,y);
                        }
                        
                    }
                    else if (baseMap[x, y].type == "Rock")
                    {
                        objectMap[x, y] = new BaseObjectModel("rock",worldPoint, x,y);
                    }
    ...
    public BaseObjectModel[,] AdjacentObjects(int x, int y)
    {
